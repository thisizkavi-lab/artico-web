...
export function EverydayLearnView({ lesson, step, setStep, speakWithBrowser, PlayIcon, LessonTitle }) {
  ...
  if (lesson?.kind === 'introductions') return <IntroductionsInteractiveLearnView lesson={lesson} speakWithBrowser={speakWithBrowser} PlayIcon={PlayIcon} LessonTitle={LessonTitle} />
